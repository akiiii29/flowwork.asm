                                ...
                                <DroppableCards {...provided.droppableProps} ref={provided.innerRef}>
                                    ...
                                    {(cards != null) ?
                                        cards.map((card, index) => (
                                            ...
                                            <TrelloCard index={index} text={card.text} key={card.id} todo={card.Todo} comment={card.Comment}title={title} id={card.id} listID={listID} boardId={boardId} indexList={indexList} />
                                        )) : null
                                    }
