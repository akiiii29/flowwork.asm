...
import { deleteCard, updateBoard, loadBoard, listenBoard } from '../../actions';
import { Button, Checkbox, Grid, Icon, Paper, TextField, Typography } from '@material-ui/core';
...
import Todo from '../BoardCardCheckList/Todo';
...
function TrelloCard({ text, id, index, listID, title, boardId, indexList,comment,todo }, props) {
    console.log(todo)
